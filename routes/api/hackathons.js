...
router.get("/", async (req, res) => {
	...
	let resp = [];
	hackathons.forEach(h => resp.push({ name: h.name, url: h.slug, description: h.description, created: h.created, _id: h._id, socials: h.socials, f_color: h.f_color, b_color: h.b_color, status: h.internal.status }));
	res.send(resp);
	...
	res.send({ name: h.name, url: h.slug, description: h.description, created: h.created, _id: h._id, socials: h.socials, f_color: h.f_color, b_color: h.b_color, status: h.internal.status });
});
